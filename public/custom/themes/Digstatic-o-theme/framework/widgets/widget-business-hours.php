 ...
 * 
 * Plugin Name: digg_Widget_Business_Hours
...
class digg_Widget_Business_Hours extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 
			...
			__( 'digg: Business Hours', 'digg' ),
			array(
				'classname'   => 'widget-business-hours',
				'description' => __( 'A custom widget that displays business hours.', 'digg' )
			) 
		);
	}
	...
	public function form( $instance ) {
		...
		<!-- Title -->
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'digg' ); ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>">
		</p>

		<!-- Description -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_description' ); ?>"><?php _e( 'Description:', 'digg' ); ?></label>
		...
		<!-- Monday-Friday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_monday_friday' ); ?>"><?php _e( 'Monday-Friday:', 'digg' ); ?></label>
		...
		<!-- Saturday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_saturday' ); ?>"><?php _e( 'Saturday:', 'digg' ); ?></label>
		...
		<!-- Sunday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_sunday' ); ?>"><?php _e( 'Sunday:', 'digg' ); ?></label>
	...
	public function widget( $args, $instance ) {
		...
		if ( $hours_monday_friday ) : ?>
			<li>
				<span><?php _e( 'Monday-Friday: ', 'digg' ); ?></span>
		...
		if ( $hours_saturday ) : ?>
			<li>
				<span><?php _e( 'Saturday: ', 'digg' ); ?></span>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "digg_Widget_Business_Hours" );' ) );
?>